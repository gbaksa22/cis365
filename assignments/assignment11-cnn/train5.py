...
selected_classes = [0, 1, 2, 3, 5]  # Classes for 'plane', 'car', 'bird', 'cat', 'dog'

def load_cifar5(batch_size=4):
...
def train(batch_size=4, epochs=2):
    trainloader, _ = load_cifar5(batch_size)
    net = Net()
    net.fc3 = nn.Linear(84, 5)  # Update the last layer for 5 classes
